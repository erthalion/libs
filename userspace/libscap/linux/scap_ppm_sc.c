...
static const ppm_sc_code *g_events_to_sc_map[] = {
        [PPME_GENERIC_E] = (ppm_sc_code[]){PPM_SC_RESTART_SYSCALL,PPM_SC_GETXATTRAT, PPM_SC_SETXATTRAT, PPM_SC_REMOVEXATTRAT, PPM_SC_LISTXATTRAT,  -1},
                                           PPM_SC_EXIT,
                                           PPM_SC_TIME,
                                           PPM_SC_GETPID,
                                           PPM_SC_SYNC,
                                           ...
                                           PPM_SC_URETPROBE,
                                           -1},
        [PPME_GENERIC_X] = (ppm_sc_code[]){PPM_SC_RESTART_SYSCALL,PPM_SC_SETXATTRAT, PPM_SC_REMOVEXATTRAT, PPM_SC_LISTXATTRAT, PPM_SC_GETXATTRAT,  -1},
                                           PPM_SC_EXIT,
                                           PPM_SC_TIME,
                                           PPM_SC_GETPID,
                                           PPM_SC_SYNC,
